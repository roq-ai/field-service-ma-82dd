...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Field Service Managment Application`}</title>

        <meta
          name="description"
          content="Welcome to Field Service Management Application - Streamlining your service requests, verifying crucial information, providing solutions, and efficiently scheduling field service engineers for optimal service delivery."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1629732902845-70eebe524b05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZXJ2aWNlJTIwcmVxdWVzdHxlbnwwfHx8fDE2OTQwNzQzNTN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Field Service Management Application - Streamlining your service requests, verifying crucial information, providing solutions, and efficiently scheduling field service engineers for optimal service delivery.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Service Request Manager"
                  type="service-request-manager"
