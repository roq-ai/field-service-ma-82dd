...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'service_request.create': {
    roles: ['service-request-manager'],
    key: 'new-service-request',
    tenantPath: ['organization', 'service_request'],
    userPath: [],
  },
  'service_request.update': {
    roles: ['service-request-manager', 'field-service-engineer', 'customer-service-representative'],
    key: 'service-request-update',
    tenantPath: ['organization', 'service_request'],
    userPath: [],
  },
  'parts_order.create': {
    roles: ['parts-order-manager'],
    key: 'parts-order-created',
    tenantPath: ['organization', 'service_request', 'activity', 'parts_order'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['service-request-manager'];
